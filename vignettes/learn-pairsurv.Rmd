...
Note: vignette so far is mostly software implementation related; hopefully Susan can bring subject area advice to the documentation
...
Three data sets are available in the package - one for the methods of each paper.
...
Here is a summary from the documentation:
 ...
 - `k` is the number of points for intergration within follow-up window [0,Tau]
