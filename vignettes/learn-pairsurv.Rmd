...
the methods of Tayob and Murray. By the end of the tutorial, you should be familiar with the functions available to users of *pairsurv* and in creating summaries, plots, and extracting other information from the three types of objects.

## Summary of methods

This package allows the user to use methods from the following three papers by Tayob and Murray:
...
Jump to the `pairtest()` function for the methods from this paper.
...
Jump to the `TM()` function for the methods from this paper. 
...
Jump to the `TM2()` function for the methods from this paper.
...
If the code above failed to execute, try installing devtools and retry the above chunk.
...
An example of analysis with `tau = 12` and all three variance estimates outputted:
...
An example of analysis with `tau = 12` and proposed variance estimate outputted:
...
An example of analysis with `tau = 12` and independent variance estimate outputted:
...
An example of analysis with `tau = 12` and sandwich variance estimate outputted:
...
Use `?` to explore other options to print and plot:
