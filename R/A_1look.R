...
#It is done and debugged as of *******6.16.97********
...
A=rev(A.reverse)
answer=list(A=A,deltay=deltay,times=times,survb=survb,f.to.integrate=f.to.integrate,
f.reverse=f.reverse,A.reverse=A.reverse)
answer
}
