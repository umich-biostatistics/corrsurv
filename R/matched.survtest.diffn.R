...
matched.survtest.9.10.99=function(x1,delta1,x2,delta2,n,
	tm=sort(unique(c(0,x1,x2))),weights="left",maxtau=100000,fudge.factor=0)  {

#n is the number of correlated indiv's and we assume they are
#sorted as in the paper, so that correlated obs come first
#up to the nth observation and then uncorrelated obs follow
...
# dyn.load("bivsurvmats.o")
# dyn.load("survinfo.o")
#dyn.load("bivsurvmats.dll")
#dyn.load("survinfo.dll")
...
dNinfo=.Fortran("bivsurvmats",as.integer(nx),as.integer(nt),as.double(tm),
...
if (weights=="left") {
	if(min(J)==0) {
		...
		upperlim=tm[upperlimmark] } else { upperlim=max(tm) }
pfweight1=rep(1,nt)
pfweight1[J==0]=0
...
answer=list(n=nx,n1=n1,n2=n2,theta=theta,pi1=pi1,pi2=pi2,
#dN1=dN1,dN2=dN2,dN12=dN12,dN1.2=dN1.2,dN2.1=dN2.1,
Y1=Y1,Y2=Y2,
#Y12=Y12,G12=G12,
logrank.cov.part=logrank.cov.part,
gehan.cov.part=gehan.cov.part,group1.lgrk=group1.lgrk,group2.lgrk=group2.lgrk,
lgrk.type.var=lgrk.type.var,gehan.cov.part=gehan.cov.part,
group1.gehan=group1.gehan,group2.gehan=group2.gehan,
gehan.type.var=gehan.type.var,
#haz1=haz1,haz2=haz2,
num.lgrk=num.lgrk,
num.gehan=num.gehan,lgrk.stat=lgrk.type,gehan.stat=gehan.type,
km1=km1,km2=km2,
pfweight1=pfweight1,
pfweight2=pfweight2,
upperlim=upperlim,
yls.cov.part=yls.cov.part,pf.cov.part=pf.cov.part,group1.yls=group1.yls,
group2.yls=group2.yls,yls.type.var=yls.type.var,
group1.pf=group1.pf,group2.pf=group2.pf,pf.type.var=pf.type.var,
yls.mean1=yls.mean1,yls.mean2=yls.mean2,pf.mean1=pf.mean1,pf.mean2=pf.mean2,
yls.stat=yls.type,pf.stat=pf.type,yls.num=yls.num,pf.num=pf.num,
lgrk.stat.p=lgrk.type.p,gehan.stat.p=gehan.type.p,lgrk.type.var.p=lgrk.type.var.p,
gehan.type.var.p=gehan.type.var.p,logrank.cov.part.p=logrank.cov.part.p,
gehan.cov.part.p=gehan.cov.part.p,group1.lgrk.p=group1.lgrk.p,group2.lgrk.p=group2.lgrk.p,
group1.gehan.p=group1.gehan.p,group2.gehan.p=group2.gehan.p,
yls.cov.part.p=yls.cov.part.p,pf.cov.part.p=pf.cov.part.p,group1.yls.p=group1.yls.p,
group2.yls.p=group2.yls.p,yls.type.var.p=yls.type.var.p,
group1.pf.p=group1.pf.p,group2.pf.p=group2.pf.p,pf.type.var.p=pf.type.var.p,
yls.stat.p=yls.type.p,pf.stat.p=pf.type.p,
lgrk.nopair.type.var=lgrk.nopair.type.var,lgrk.nopair.type.var.p=lgrk.nopair.type.var.p,
gehan.nopair.type.var=gehan.nopair.type.var,gehan.nopair.type.var.p=gehan.nopair.type.var.p,
lgrk.nopair.stat=lgrk.nopair.type,gehan.nopair.stat=gehan.nopair.type,
lgrk.nopair.stat.p=lgrk.nopair.type.p,gehan.nopair.stat.p=gehan.nopair.type.p,
yls.nopair.type.var=yls.nopair.type.var,yls.nopair.type.var.p=yls.nopair.type.var.p,
pf.nopair.type.var=pf.nopair.type.var,pf.nopair.type.var.p=pf.nopair.type.var.p,
yls.nopair.stat=yls.nopair.type,pf.nopair.stat=pf.nopair.type,
yls.nopair.stat.p=yls.nopair.type.p,pf.nopair.stat.p=pf.nopair.type.p)
answer
}
